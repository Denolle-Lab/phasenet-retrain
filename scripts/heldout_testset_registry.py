...
SEQUENCES = [
    ...
    _seq(key="kaikoura_2016", label="Kaikoura 2016", regime="msas", tier=1, suite="acceptance",
    ...
    _seq(key="norcia_2016", label="Norcia 2016", regime="msas", tier=1, suite="acceptance",
    ...
    _seq(key="thessaly_2021", label="Thessaly 2021", regime="msas", tier=1, suite="acceptance",
    ...
    _seq(key="kahramanmaras_2023", label="Kahramanmaras 2023", regime="msas", tier=1, suite="acceptance",
    ...
    _seq(key="noto_2024", label="Noto 2024", regime="msas", tier=1, suite="acceptance",
    ...
    _seq(key="hualien_2024", label="Hualien 2024", regime="msas", tier=1, suite="acceptance",
    ...
    _seq(key="petrinja_2020", label="Petrinja 2020", regime="msas", tier=1, suite="acceptance",
    ...
    _seq(key="samos_2020", label="Samos 2020", regime="msas", tier=1, suite="dev",
         lat=37.90, lon=26.79, radius=1.0, mainshock="2020-10-30T11:51:27Z", mag=7.0,
         picks=[dict(kind="fdsn_region", client="NOA", min_mag=2.0)],
         windows=dict(kind="mainshock", start_s=600, minutes=180),
         waveform_routes=["NOA", "KOERI"], extra_stations=[GSN["ANTO"]]),
    _seq(key="adriatic_2022", label="Adriatic 2022", regime="msas", tier=1, suite="dev",
    ...
    _seq(key="reykjanes_2023", label="Reykjanes 2023 dike", regime="vt", tier=1, suite="acceptance",
    ...
    _seq(key="fagradalsfjall_2021", label="Fagradalsfjall 2021", regime="vt", tier=1, suite="acceptance",
    ...
    _seq(key="la_palma_2021", label="La Palma 2021", regime="vt", tier=1, suite="acceptance",
    ...
    _seq(key="santorini_2025", label="Santorini-Amorgos 2025", regime="vt", tier=1, suite="acceptance",
         ...
         waveform_routes=["NOA"]),
    _seq(key="etna_2022_2024", label="Etna 2022-2024", regime="vt", tier=1, suite="dev",
    ...
    _seq(key="west_bohemia_2018", label="West Bohemia 2018", regime="swarm", tier=1, suite="acceptance",
    ...
    _seq(key="noto_swarm_2023", label="Noto swarm 2023", regime="swarm", tier=1, suite="acceptance",
    ...
    _seq(key="campi_flegrei_2023", label="Campi Flegrei 2023", regime="swarm", tier=1, suite="acceptance",
    ...
    _seq(key="corinth_thiva_2020", label="Corinth-Thiva 2020-2021", regime="swarm", tier=1, suite="dev",
